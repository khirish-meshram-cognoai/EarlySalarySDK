//
//  EarlySalarySDK.swift
//  EarlySalarySDK
//
//  Created by Khirish Meshram on 20/12/22.
//
...
//  Change string url to with verified url
            if let _url = URL(string: Constants.botUrl + "/chat/index/?id=" + Constants.botId + "&customerId=" + Constants.customerId + "&channel=iOS") {
